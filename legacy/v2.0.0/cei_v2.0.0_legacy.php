<?php
/**
 * CEI - Comfort Environment Index (legacy)
 *
 * Version 2.0.0
 * Build Date 2025/11/17
 * !!! This version has been superseded by CEI v3.0.0 !!!
 * 
 * - Tuned mainly for temperate climates
 * - Does NOT include explicit risk capping for extreme events
 * - Not recommended for use in high-risk environments (mountain, avalanche, polar, tropical extremes)
 * 
 * Copyright © Caner HK
